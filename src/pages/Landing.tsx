...
const cards = [
{
  id: "one-time",
  icon: UserRound,
  label: "Meet Sarah (NHS Patient Demo)",
  subtitle: "Who she is, her condition and medication",
  route: "/one-time",
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-6 py-12 max-w-lg mx-auto relative">
      ...
      <motion.div
        ...
        <p className="text-muted-foreground text-xs mt-3 max-w-xs mx-auto leading-relaxed">A smart nutrition companion for patients and their dietitians. Track meals, medication and clinical insights in real time, across any condition where nutrition matters.
